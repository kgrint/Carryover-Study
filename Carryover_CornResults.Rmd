...
```
Lancaster Stand counts should be closer to 80,000 and Havelock should be closer to 79,000
...
## Figure with Soil:site-Years
```{r}
cn_canopy
```

## Figure with herbicide
```{r}
cn_canopyherb
```

# Canopy by Location --------- Chose to go with Condensed analysis
