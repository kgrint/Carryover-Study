...
hav20_soy_can_lsmeans= emmeans(hav_soy_can ,~ soil, contr="pairwise", adjust="none", type="response")
hav20_soy_canCLD<- CLD(hav_soy_can_lsmeans, alpha=0.05, Letters=letters, adjust="none", sort=TRUE, reverse=TRUE)
...
### Corn
```{r}
cn_stand= lmer(stand_count~ site_crop_yr*soil*herb + (1|site_crop_yr:rep), data= (filter(Corn1, !site_crop_yr == "ARL_CN_20")))
